...
the first two parameters  $beta_0$, $beta_1$ representing the level and the slope of the desired yield curve, $beta_2$, $lambda_1$ being the first curvature factor (the magnitude of the first “hump” in the curve) and its location (typically the short-to-medium maturities), respectively, and the parameters $beta_3$, $lambda_2$ corresponding to the second curvature factor and its location (longer maturities due to the amplified convexity effect), respectively.
